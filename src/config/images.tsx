export default {
  ...
  ic_footwear: require('../assets/images/ic_footwear.png'),
  ic_money: require('../assets/images/ic_money.png'),
  ic_toys: require('../assets/images/ic_toys.png'),

  // temp
  food_1: require('../assets/temp/food_1.png'),
  food_2: require('../assets/temp/food_2.png'),
  food_3: require('../assets/temp/food_3.png'),
  food_4: require('../assets/temp/food_4.png'),
  temp_logo_square: require('../assets/temp/temp_logo_square.png'),
};
